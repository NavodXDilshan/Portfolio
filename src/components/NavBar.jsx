...
const NavBar = () => {
  ...
  return (
    <nav className='fixed top-0 right-0 left-0 z-10 bg-[#121212] bg-[rgba(18,18,18,0.9)]'><div className='flex flex-wrap items-center justify-between mx-auto px-4 py-2'>
